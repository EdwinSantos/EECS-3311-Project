...
feature -- command
	remove_container(cid: STRING)
    	...
    	do
			...
			create remove_cn_oper.make(cid , model.state.get_state_msg,model.get_i)
			if not remove_cn_oper.is_invalid then
				...
				create message_oper.make (model.state.get_state_msg,remove_cn_oper.get_error, model.get_i)
